  ...
  Widget build(BuildContext context) {
    return GetBuilder<ProfileController>(builder: (profileController) {
      ...
      return Column(children: [
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Container(
              ...
              child: DropdownButton<String>(
                hint: profileController.identityType.tr.isEmpty ? Text('select_identity_type'.tr) : Text(
            ...
            Padding(padding:  const EdgeInsets.fromLTRB(Dimensions.paddingSizeDefault, 0, Dimensions.paddingSizeDefault, Dimensions.paddingSizeDefault),
              child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, index){
                    ...
                    InkWell(onTap: ()=> profileController.pickImage(false, false,),
                      child: DottedBorder(
                        strokeWidth: 2,
                      ...
                      Padding(padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeSmall),
                        child: Container(decoration: const BoxDecoration(color: Colors.white,
                          ...
                          child: ClipRRect(borderRadius: const BorderRadius.all(Radius.circular(Dimensions.paddingSizeExtraSmall)),
                            child:  Image.file(File(profileController.identityImages[index].path),
                              width: MediaQuery.of(context).size.width,
        ...
        profileController.isUpdating ?  Center(child: SpinKitCircle(color: Theme.of(context).primaryColor, size: 40.0,)) : CustomButton (
          ...
          onPressed: () async {
            ...
            if(widget.fromAccount && response.statusCode == 200) {
