...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: CustomBody(
        appBar: CustomAppBar(title: 'profile_info', showBackButton: true, onBackPressed: () {
          if(widget.fromLogin) {
            onBackPressed();
          }else{
            Get.back();
                ...
                InkWell(onTap:() => profileController.pickImage(false, true),
                  child: Container(decoration: BoxDecoration(shape: BoxShape.circle,
                    ...
                    child: Stack(clipBehavior: Clip.none, children: [
                      ...
                      profileController.pickedProfileFile == null ? ClipRRect(
                      ...
                      ) : CircleAvatar(radius: 35, backgroundImage:FileImage(File(profileController.pickedProfileFile!.path))),
