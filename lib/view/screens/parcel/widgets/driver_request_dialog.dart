    ...
    return  Padding(
      ...
      child: GetBuilder<RideController>(
        builder: (rideController) {
          ...
          return rideController.biddingList.isNotEmpty? Padding(
            padding: EdgeInsets.only(top: fromList? 0 : 100),
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children:  [
                Expanded(child: Material(borderRadius: BorderRadius.circular(Dimensions.radiusLarge),
