...
class HtmlViewerScreen extends StatelessWidget {
  ...
  final bool isLegal;
  final String? image;
  const HtmlViewerScreen({super.key, this.isPolicy = false,  this.isLegal = false, this.image});
          ...
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              ...
              background: Stack(fit: StackFit.expand,
                children: [
                  CustomImage(image: '${AppConstants.baseUrl}/storage/app/public/business/pages/${image ?? ''}'),
