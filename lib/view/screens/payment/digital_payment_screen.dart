...
import 'package:ride_sharing_user_app/view/widgets/animated_custom_dialog.dart';
import 'package:ride_sharing_user_app/view/widgets/digital_payment_dialog.dart';
...
class MyInAppBrowser extends InAppBrowser {
  ...
  void onExit() {
    if(_canRedirect) {
      ...
      showAnimatedDialog(context, DigitalPaymentDialog(
        icon: Icons.clear,
