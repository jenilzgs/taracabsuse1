...
class LoyaltyPointConvertedSuccessfullyDialog extends StatelessWidget {
  const LoyaltyPointConvertedSuccessfullyDialog({super.key});
        ...
        child: Column(mainAxisSize: MainAxisSize.min,
          ...
          Padding(padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeDefault),
            child: Text.rich(TextSpan(children: [
              ...
              const TextSpan(text: ' '),
              TextSpan(text: 'successfully'.tr, style: textBold.copyWith(color: Theme.of(context).primaryColor))],
              ),
            ),
          ),
          InkWell(onTap: (){
            ...
            child: Padding(padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeDefault),
              child: Text('check_wallet'.tr, style: textRegular.copyWith(decoration: TextDecoration.underline,
