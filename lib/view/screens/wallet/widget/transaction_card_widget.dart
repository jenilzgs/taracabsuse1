              ...
              child: Row(children: [
                ...
                Expanded(child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text(' ${transaction.attribute!.replaceAll('_', ' ').capitalize}', style: textSemiBold.copyWith(color: Theme.of(context).primaryColor)),
                ...
                Container(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault, vertical: Dimensions.paddingSizeSeven),
                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(100),
                    color: transaction.debit! > 0 ? Theme.of(context).colorScheme.error.withOpacity(0.15)
                        : Theme.of(context).primaryColor.withOpacity(0.15)),
                  child: Text(PriceConverter.convertPrice(transaction.debit! > 0 ? transaction.debit!:transaction.credit!),
