...
class _ResetPasswordScreenState extends State<ResetPasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        body: CustomBody(appBar: CustomAppBar(title: widget.fromChangePassword ? 'change_password'.tr : 'reset_password'.tr,
          ...
          body: GetBuilder<AuthController>(builder: (authController){
            return Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                widget.fromChangePassword ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
