...
class CustomCalender extends StatefulWidget {
  ...
  const CustomCalender({super.key, required this.onChanged});
            ...
            Column(children: [
              Padding(padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeLarge),
                ...
                Padding(padding: const EdgeInsets.only(right: 50),
                  child: Card(color: Colors.transparent, elevation: 0,
                ...
                CustomButton(radius: Dimensions.paddingSizeExtraLarge,
                  onPressed:(){
